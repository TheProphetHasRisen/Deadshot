...
#   page/head.html     <title>, font preloads, and __CSS__
#   page/fonts.css     the six @font-face rules -- GENERATED by mkfonts.py, which also
#                      fills fonts/ with the files; never hand-edit either
...
HEAD = _part('head.html').replace('__CSS__', _part('fonts.css') + _part('site.css'))
